...
public class Options {
	...
	public static File getSkinRootDir() {
		// use download directory, if found
//		File downloadDir = DeviceInfo.info.getDownloadDir();
//		if (downloadDir != null) {
//			skinRootDir = new File(downloadDir, SKIN_ROOT_DIR.getName());
...
//		}
	...
	public static Beatmap getThemeBeatmap() {
		...
		try {
			beatmap.timingPoints = new Array<>(1);
